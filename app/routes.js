module.exports = {
    ...
    require('./routes-includes/beta18-routes.js')(app);
    require('./routes-includes/beta19-routes.js')(app);
    require('./routes-includes/beta20-routes.js')(app);
    ...
    // Include new benefit flow routes
    require('./routes-includes/new-benefits-flow-routes.js')(app);
    require('./routes-includes/new-benefits-flow-routes-v2.js')(app);
